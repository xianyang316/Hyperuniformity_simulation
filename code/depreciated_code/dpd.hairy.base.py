...
# specify information for PGN (particle grafted nanoparticles)
...
hoomd.analyze.log(filename="log-dpd.hairy.log",
                  ...
                  period=100,
                  overwrite=True)
hoomd.dump.gsd("dpd.hairy.gsd", period=5e4, group=hoomd.group.all(), overwrite=True, dynamic=["momentum"])
