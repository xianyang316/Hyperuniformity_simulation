...
hoomd.analyze.log(filename="log-slj.single.array.log",
                  quantities=["potential_energy", "temperature", "lx", "ly", "lz"],
                  period=100,
                  overwrite=True)
hoomd.dump.gsd("slj.single.array.gsd", period=1e5, group=hoomd.group.all(), overwrite=True, dynamic=["momentum"])
